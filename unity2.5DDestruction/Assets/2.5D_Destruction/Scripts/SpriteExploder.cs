...
public static class SpriteExploder
{
    public static List<GameObject> GenerateTriangularPieces(GameObject source, int extraPoints = 0, int subshatterSteps = 0, Material mat = null)
    {
        ...
        PolygonCollider2D sourcePolyCollider = source.AddComponent<PolygonCollider2D>();
        BoxCollider2D sourceBoxCollider = source.AddComponent<BoxCollider2D>();
    ...
    private static GameObject generateTriangularPiece(GameObject source, List<Vector2> tri, Vector3 origScale, Quaternion origRotation, Material mat)
    {
    ...
    public static List<GameObject> GenerateVoronoiPieces(GameObject source, int extraPoints = 0, int subshatterSteps = 0, Material mat = null)
    {
        ...
        foreach (List<Vector2> region in voronoi.Regions())
        {
            ...
            {
                pieces.Add(generateVoronoiPiece(source, clippedRegion, origScale, origRotation, mat));
            }
        }
    ...
    private static GameObject generateVoronoiPiece(GameObject source, List<Vector2> region, Vector3 origScale, Quaternion origRotation, Material mat)
    {
        //Create Game Object and set transform settings properly
        GameObject piece = new GameObject(source.name + " piece");
